...
/**
 * Imported by Simon on 2016-09-18.
 */
 ...
 */
public class EntryViewAnimated extends ExpandableListView {
    ...
    public EntryViewAnimated(Context context) {
        super(context);
    }

    public EntryViewAnimated(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EntryViewAnimated(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private EntryViewAnimated parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(EntryViewAnimated parent) {
            this.parent = parent;
        }
